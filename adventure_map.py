...
desc={'13':'A small sign hanging above a building made of bricks as opposed to wooden house besides it. One can barely makes out the writing on the sign to read \n\"Stella\'s potion store\" \nInside there\'s a counter similar to a bar but instead of liquor on the shelf, \nit is filled with numerous bottles of coloured liquids. \nBehind the counter stood one girl... ',
     ...
     '12':'The Town is embellished with cobbled and paved streets, there are also a number of natural baths. There are Victorian townhouses and a mixture of \nsemi-detached and detached houses. A shop is located to the NORTH, the Plains of Lithlad to the EAST and a tavern to the SOUTH. \nWhat would you like to do?',
     ...
     '22':'You arrive upon a grassy plain, before you miles of grass can be seen waving in the mild breeze that gently flows eastward. The sun shines timidly, \nbathing the plains in light, and in the distance to the SOUTH you can see a lake reflecting it. The Town stands to the WEST, a bit of black smoke rising \nfrom it due to a recent goblin invasion. Further NORTH, you can see that the flat plain becomes slightly hilly. What would you like to do?',
     '23':'A grassy valley spreads out in front of you. Bushes grow around the prominent rocks and small animals scurry all around the place. In the NORTH you can \nsee the valley rising and melding into mountains covered in forest with a farm at their base. Towards the EAST a terrible black gate blocks the way, \npatrolled by goblin archers and trolls. In the SOUTH, the plains flatten down and become a vast land of grass. What would you like to do?',
     '21':'You arrive at the Ancient Lake. The lake is very beautiful in the sunlight, large and full of water\'s edge creatures. You can hear the sound of \ngushing water and presume it\'s the waterfall connected to the lake which is towards the east. The sound is quite odd however, as there is a strange echo. \nA glistening light catches your gaze, you notice something in the lake. Towards the north, you see luscious grass,  it can only be the Plains of Lithlad. \nWhat would you like to do?',
     '31':'The Cave is particularly large and has humid conditions. The water falls at a fast pace and the water is murky. At the end of the room you can see a \nmagical pendant radiating with power and lighting the room with multicoloured beams. As you approach, an apparition appears in front of you, challenging to a fight. \nWhat would you like to do?',
     '24':'You arrive on a destroyed farm, it has been burnt to the ground and the stones that held the roof have been thrown down. Nothing but ruins remain; the \nlifeless bodies of the parents are nowhere in sight... either they fled or were devoured.',
     '14':'You are standing in the forest of Eryn Vanwë. Bars of light pierce the canopy of oak and beech, illuminating the glossy leaves of the shrubs below. The \nodours of damp earth and wild garlic mingle with the smell of the burning farm to the EAST. A dirt trail leads to the NORTH, deeper into the woods and \ntowards a cluster of shabby huts and tents. What would you like to do?',
     '15':'You have found the goblin lair. The goblins\' primitive shelters are in poor shape, with rotting wooden frames covered in brightly-coloured fungi. \nInside the huts, you see mouldy blankets, crude blackthorn cudgels, and the carcasses of the farmer\'s livestock. A blackened, unplucked chicken burns over a \ncampfire. The forest trail leads SOUTH, out of the lair. What would you like to do?',
     }
...
#determining actions after reaching new location v
    ...
    if world[newloc]['type'] == '1':#if type is 1 print location
        ...
        print(desc["24"])
        if questCounter == 1:
            print("You are filled with rage and vow to make the goblins pay for their cruelty. You have heard of a lair in the forest to the WEST.")
            questCounter = 3
