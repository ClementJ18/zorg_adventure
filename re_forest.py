...
def re_forest_encounter_1():
    ...
    print("You come across an old man sat at the base of a tree. Noticing your presence, he slowly turns his head and looks up at you, but his gaze appears unfocused. \n'My boy,' he says. I've been lost in these woods for days and I'm parched. Won't you go to the nearby farm and ask them for a pail of water? At this rate, \nI won't have the energy to make it home...'")
    print()
    while True:
        print("You can:")
...
def re_forest_encounter_2():
    ...
    while True:
        ...
        if player_input == "offer":
            ...
            print("The old man opens his eyes and sees the pail of water. You lift it to his lips and gently tip some of its contents into his mouth. \'Bless you, \nmy boy,\' he whispers. 'Here, take these...' He slowly reaches into his pocket and retrieves 5 copper coins. You place the pail beside him, take the \ncoins and give him directions before returning to the trail.")
            print()
